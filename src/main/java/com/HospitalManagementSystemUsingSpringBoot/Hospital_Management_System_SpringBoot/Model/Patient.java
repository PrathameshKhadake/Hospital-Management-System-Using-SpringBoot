...
public class Patient {
    ...
    public Patient(String patientID, String patientName, String patientGender, int patientAge, String patientAddress, String patientDesease, String patientAdmitDate) {
